...
# Initialize a candidate and county list, and a candidate and county dictionary
candidate_options = []
county_options = []
candidate_votes = {}
county_votes = {}
...
# Track the winning candidate, the winning county, the vote count and percentage
winning_candidate = ""
winning_count = 0
...
with open(file_to_save, "a") as txt_file:
    ...
    winning_county_summary = (
        ...
        f"Number of Votes: {winning_county_count:,}\n"
        f"Voting Percentage: {winning_county_percentage:.1f}%\n"
        f"-------------------------\n\n"
